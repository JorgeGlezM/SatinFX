 ...
 * @author Jorge
 */
public class LCentrosTrabajoViewController implements Initializable {
    ...
    //Cambiamos la escena
                CentrosTrabajoViewController.edicion=false;
                root = FXMLLoader.load(getClass().getResource("/view/CentrosTrabajoView.fxml"));
        ...
        @FXML private void btnEdit (ActionEvent event) throws IOException{
                ...
                CentrosTrabajoViewController.edicion=true;
                CentrosTrabajoViewController.idEdicion=selected;
                //Cambiamos la escena
                root = FXMLLoader.load(getClass().getResource("/view/CentrosTrabajoView.fxml"));
                stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                scene = new Scene(root);
    ...
    public void load(){
        ...
        mysql.conectar();
        ResultSet rs = mysql.select("Select * from centrotrabajo");
        try {

 ...
 * @author Jorge
 */
public class LConceptosSATViewController implements Initializable {
    ...
    //Cambiamos la escena
                ConceptosSATViewController.edicion=false;
                root = FXMLLoader.load(getClass().getResource("/view/ConceptosSATView.fxml"));
                stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                scene = new Scene(root);
                stage.setScene(scene);
                //Creamos un rectángulo del tamaño de la pantalla para obtener medidas y centrar la ventana antes de mostrarla
        ...
        @FXML private void btnEdit (ActionEvent event) throws IOException{
                ...
                ConceptosSATViewController.edicion=true;
                ConceptosSATViewController.idEdicion=selected;
                //Cambiamos la escena
                root = FXMLLoader.load(getClass().getResource("/view/ConceptosSATView.fxml"));
                stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                scene = new Scene(root);
    ...
    public void load(){
        ...
        mysql.conectar();
        ResultSet rs = mysql.select("Select * from conceptos_sat");
        try {
